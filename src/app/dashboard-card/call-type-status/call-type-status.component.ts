...
@Component({
  selector: 'app-call-type-status',
  templateUrl: './call-type-status.component.html',
  styleUrls: ['./call-type-status.component.css']
})
export class CallTypeStatusComponent implements OnInit {
  excel: any;
